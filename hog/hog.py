...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    player_score_last_digit =player_score%10
    opponent_score_last_digit =opponent_score%10
    player_score_first_digit = (player_score//10)%10
    opponent_score_first_digit =(opponent_score//10)%10
    if abs(player_score_last_digit-player_score_first_digit)==abs(opponent_score_last_digit-opponent_score_first_digit):
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(new_score,opponent_score) and opponent_score>new_score:
        return 0
    elif (new_score-score)>=margin and is_swap(new_score,opponent_score)==False:
        return 0
    else:
        return num_rolls
